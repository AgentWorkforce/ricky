  ...
  switch (choice) {
    case 'local':
      return [
        ...
        '                `ricky run <artifact>` to launch the artifact through local agent-relay.',
        '',
        '  Returned to you locally: the generated artifact path, logs, warnings, and — on --run —',
        '  classified blockers and execution evidence (stdout/stderr paths, exit code, duration).',
        '',
        ...
        '  - Run an artifact:   ricky run workflows/generated/<file>.ts',
    ...
    case 'cloud':
      return [
        ...
        '  - return generated artifacts and any Cloud-side execution results that come back',
        '',
        '  Note: this CLI slice does not stream Cloud execution evidence — what you see is what',
        '  the Cloud generate endpoint returns plus any follow-up actions it suggests.',
        '',
