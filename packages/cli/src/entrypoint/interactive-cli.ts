...
import type { CloudExecutor, CloudGenerateResult } from '@ricky/cloud/api/generate-endpoint';
import type { CloudGenerateRequest } from '@ricky/cloud/api/request-types';
import type { LocalExecutor, LocalResponse } from '@ricky/local/entrypoint';
import type { RawHandoff } from '@ricky/local/request-normalizer';
import type { Diagnosis, DiagnosticSignal } from '@ricky/runtime/diagnostics/failure-diagnosis';
...
import { handleCloudGenerate } from '@ricky/cloud/api/generate-endpoint';
import { runLocal } from '@ricky/local/entrypoint';
