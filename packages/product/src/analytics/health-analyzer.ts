import { summarizeEvidence } from '@ricky/runtime/evidence/capture.js';
import { classifyFailure } from '@ricky/runtime/failure/classifier.js';
import { FailureClass, type FailureClassification } from '@ricky/runtime/failure/types.js';
import type { SwarmPattern, WorkflowConfig } from '@ricky/shared/models/workflow-config.js';
import type {
  DeterministicGateResult,
  VerificationResult,
  WorkflowRunEvidence,
  WorkflowStepEvidence,
} from '@ricky/shared/models/workflow-evidence.js';
import type {
  FindingCategory,
  FindingSeverity,
  HealthAnalysisInput,
