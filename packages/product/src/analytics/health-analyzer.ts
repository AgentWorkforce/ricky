import { summarizeEvidence } from '@ricky/runtime/evidence/capture';
import { classifyFailure } from '@ricky/runtime/failure/classifier';
import { FailureClass, type FailureClassification } from '@ricky/runtime/failure/types';
import type { SwarmPattern, WorkflowConfig } from '@ricky/shared/models/workflow-config';
import type {
