...
- It should mention banner, welcome, onboarding, local/BYOH, Cloud, CLI, MCP, and at least one recovery path.`,
    ...
    .step('post-write-file-gate', {
      ...
      command: [
        ...
        'grep -qi "CLI" docs/product/ricky-cli-onboarding-ux-spec.md',
        'grep -qi "MCP" docs/product/ricky-cli-onboarding-ux-spec.md',
        'grep -qi "Slack\|web" docs/product/ricky-cli-onboarding-ux-spec.md',
        'grep -qi "cloud connect google\|agent-relay cloud connect google" docs/product/ricky-cli-onboarding-ux-spec.md',
        'grep -qi "GitHub\|Nango\|dashboard" docs/product/ricky-cli-onboarding-ux-spec.md',
...
Write .workflow-artifacts/wave4-local-byoh/cli-onboarding-ux-spec/final-review-codex.md ending with FINAL_REVIEW_CODEX_PASS or FINAL_REVIEW_CODEX_FAIL.`,
    ...
    .step('final-review-pass-gate', {
      ...
      command: [
        'tail -n 1 .workflow-artifacts/wave4-local-byoh/cli-onboarding-ux-spec/final-review-claude.md | grep -Eq "^FINAL_REVIEW_CLAUDE_PASS$"',
        'tail -n 1 .workflow-artifacts/wave4-local-byoh/cli-onboarding-ux-spec/final-review-codex.md | grep -Eq "^FINAL_REVIEW_CODEX_PASS$"',
