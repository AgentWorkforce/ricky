...
- do not add live external dependencies`,
    ...
    .step('regression-gate', {
      ...
      command: [
        'changed="$(git diff --name-only -- packages/cli/src/cli workflows/wave4-local-byoh/04-implement-cli-onboarding-from-ux-spec.ts workflows/shared/scripts/restore-ricky-cli-onboarding.sh docs/architecture/ricky-wave4-runtime-completion-findings.md docs/architecture/ricky-runtime-notes.md; git ls-files --others --exclude-standard -- .workflow-artifacts/wave4-local-byoh/implement-cli-onboarding-from-ux-spec)"',
        'printf "%s\n" "$changed" | grep -Eq "^(packages/cli/src/cli/|workflows/wave4-local-byoh/04-implement-cli-onboarding-from-ux-spec\.ts|workflows/shared/scripts/restore-ricky-cli-onboarding\.sh|docs/architecture/ricky-wave4-runtime-completion-findings\.md|docs/architecture/ricky-runtime-notes\.md|\.workflow-artifacts/wave4-local-byoh/implement-cli-onboarding-from-ux-spec/)"',
        'if [ -n "$changed" ]; then ! printf "%s\n" "$changed" | grep -Ev "^(packages/cli/src/cli/|workflows/wave4-local-byoh/04-implement-cli-onboarding-from-ux-spec\.ts|workflows/shared/scripts/restore-ricky-cli-onboarding\.sh|docs/architecture/ricky-wave4-runtime-completion-findings\.md|docs/architecture/ricky-runtime-notes\.md|\.workflow-artifacts/wave4-local-byoh/implement-cli-onboarding-from-ux-spec/)"; else true; fi',
