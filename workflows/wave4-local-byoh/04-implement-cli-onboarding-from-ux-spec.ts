  ...
  const result = await workflow('ricky-wave4-implement-cli-onboarding-from-ux-spec')
    ...
    .step('post-restore-source-gate', {
      ...
      command: [
        ...
        "grep -q 'banner\\|compact\\|show' src/surfaces/cli/cli/ascii-art.ts",
        "grep -q 'firstRun\\|Ricky' src/surfaces/cli/cli/welcome.ts",
        "grep -q 'local\\|BYOH' src/surfaces/cli/cli/mode-selector.ts",
        "grep -q 'Cloud' src/surfaces/cli/cli/mode-selector.ts",
    ...
    .step('post-implementation-file-gate', {
      ...
      command: [
        ...
        'test -f src/surfaces/cli/cli/onboarding.ts',
        'test -f src/surfaces/cli/cli/index.ts',
        "grep -q 'local\\|BYOH' src/surfaces/cli/cli/mode-selector.ts src/surfaces/cli/cli/onboarding.ts",
        "grep -q 'Cloud' src/surfaces/cli/cli/mode-selector.ts src/surfaces/cli/cli/onboarding.ts",
        "grep -q 'agent-relay cloud connect google\\|cloud connect google' src/surfaces/cli/cli/onboarding.ts",
        "grep -q 'GitHub\\|dashboard\\|Nango' src/surfaces/cli/cli/onboarding.ts",
    ...
    .step('implement-cli-tests', {
      ...
      command: 'test -f src/surfaces/cli/cli/onboarding.test.ts && echo CLI_ONBOARDING_TESTS_READY',
      captureOutput: true,
      failOnError: true,
    })
    .step('post-test-file-gate', {
      ...
      command: [
        ...
        "grep -q 'local\\|BYOH' src/surfaces/cli/cli/onboarding.test.ts",
        "grep -q 'Cloud' src/surfaces/cli/cli/onboarding.test.ts",
        "grep -q 'cloud connect google\\|agent-relay cloud connect google' src/surfaces/cli/cli/onboarding.test.ts",
        "grep -q 'GitHub\\|Nango\\|dashboard' src/surfaces/cli/cli/onboarding.test.ts",
        "grep -q 'recovery\\|missing\\|blocked' src/surfaces/cli/cli/onboarding.test.ts src/surfaces/cli/cli/onboarding.ts",
...
- do not add live external dependencies`,
    ...
    .step('post-fix-verification-gate', {
      ...
      command: [
        ...
        'test -f src/surfaces/cli/cli/onboarding.ts',
        'test -f src/surfaces/cli/cli/onboarding.test.ts',
        "grep -q 'local\\|BYOH' src/surfaces/cli/cli/onboarding.ts src/surfaces/cli/cli/onboarding.test.ts",
        "grep -q 'Cloud' src/surfaces/cli/cli/onboarding.ts src/surfaces/cli/cli/onboarding.test.ts",
    ...
    .step('regression-gate', {
      ...
      command: [
        'changed="$(git diff --name-only -- src/surfaces/cli/cli workflows/wave4-local-byoh/04-implement-cli-onboarding-from-ux-spec.ts workflows/shared/scripts/restore-ricky-cli-onboarding.sh docs/architecture/ricky-wave4-runtime-completion-findings.md docs/architecture/ricky-runtime-notes.md; git ls-files --others --exclude-standard -- .workflow-artifacts/wave4-local-byoh/implement-cli-onboarding-from-ux-spec)"',
        'printf "%s\n" "$changed" | grep -Eq "^(src/surfaces/cli/cli/|workflows/wave4-local-byoh/04-implement-cli-onboarding-from-ux-spec\.ts|workflows/shared/scripts/restore-ricky-cli-onboarding\.sh|docs/architecture/ricky-wave4-runtime-completion-findings\.md|docs/architecture/ricky-runtime-notes\.md|\.workflow-artifacts/wave4-local-byoh/implement-cli-onboarding-from-ux-spec/)"',
        'if [ -n "$changed" ]; then ! printf "%s\n" "$changed" | grep -Ev "^(src/surfaces/cli/cli/|workflows/wave4-local-byoh/04-implement-cli-onboarding-from-ux-spec\.ts|workflows/shared/scripts/restore-ricky-cli-onboarding\.sh|docs/architecture/ricky-wave4-runtime-completion-findings\.md|docs/architecture/ricky-runtime-notes\.md|\.workflow-artifacts/wave4-local-byoh/implement-cli-onboarding-from-ux-spec/)"; else true; fi',
