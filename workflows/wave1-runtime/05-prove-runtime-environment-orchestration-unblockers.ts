...
async function main() {
  const result = await workflow('ricky-wave1-prove-runtime-environment-orchestration-unblockers')
    ...
    .step('final-review-pass-gate', {
      ...
      command: [
        'tail -n 1 .workflow-artifacts/wave1-runtime/prove-runtime-environment-orchestration-unblockers/final-review-claude.md | grep -Eq "^FINAL_REVIEW_CLAUDE_PASS$"',
        'tail -n 1 .workflow-artifacts/wave1-runtime/prove-runtime-environment-orchestration-unblockers/final-review-codex.md | grep -Eq "^FINAL_REVIEW_CODEX_PASS$"',
    ...
    .step('regression-gate', {
      ...
      command: [
        'changed="$(git diff --name-only -- src/runtime/diagnostics workflows/wave1-runtime/05-prove-runtime-environment-orchestration-unblockers.ts; git ls-files --others --exclude-standard -- .workflow-artifacts/wave1-runtime/prove-runtime-environment-orchestration-unblockers)"',
        'printf "%s\n" "$changed" | grep -Eq "^(src/runtime/diagnostics/|workflows/wave1-runtime/05-prove-runtime-environment-orchestration-unblockers\\.ts|\\.workflow-artifacts/wave1-runtime/prove-runtime-environment-orchestration-unblockers/)"',
        '! printf "%s\n" "$changed" | grep -Ev "^(src/runtime/diagnostics/|workflows/wave1-runtime/05-prove-runtime-environment-orchestration-unblockers\\.ts|\\.workflow-artifacts/wave1-runtime/prove-runtime-environment-orchestration-unblockers/)"',
