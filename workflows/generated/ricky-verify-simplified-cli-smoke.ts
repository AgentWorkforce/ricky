...
async function main() {
  const result = await workflow("ricky-verify-simplified-cli-smoke")
    .description("verify simplified CLI smoke")
    .pattern("pipeline")
    .channel("wf-ricky-verify-simplified-cli-smoke")
    .maxConcurrency(1)
    .timeout(600000)
    .onError('fail-fast')
    ...
    .step("skill-boundary-metadata-gate", {
      ...
      command: "test -f '.workflow-artifacts/generated/verify-simplified-cli-smoke/skill-application-boundary.json' && test -f '.workflow-artifacts/generated/verify-simplified-cli-smoke/skill-matches.json' && test -f '.workflow-artifacts/generated/verify-simplified-cli-smoke/tool-selection.json' && grep -F 'generation_time_only' '.workflow-artifacts/generated/verify-simplified-cli-smoke/skill-application-boundary.json' && grep -F '\"runtimeEmbodiment\":false' '.workflow-artifacts/generated/verify-simplified-cli-smoke/skill-application-boundary.json' && grep -F 'writing-agent-relay-workflows' '.workflow-artifacts/generated/verify-simplified-cli-smoke/skill-application-boundary.json' && grep -F '\"stage\":\"generation_selection\"' '.workflow-artifacts/generated/verify-simplified-cli-smoke/skill-application-boundary.json' && grep -F '\"stage\":\"generation_loading\"' '.workflow-artifacts/generated/verify-simplified-cli-smoke/skill-application-boundary.json' && grep -F '\"effect\":\"metadata\"' '.workflow-artifacts/generated/verify-simplified-cli-smoke/skill-application-boundary.json' && grep -F '\"stage\":\"generation_rendering\"' '.workflow-artifacts/generated/verify-simplified-cli-smoke/skill-application-boundary.json' && grep -F '\"effect\":\"workflow_contract\"' '.workflow-artifacts/generated/verify-simplified-cli-smoke/skill-application-boundary.json'",
      captureOutput: true,
      failOnError: true,
    })
...
- Read .workflow-artifacts/generated/verify-simplified-cli-smoke/skill-application-boundary.json and treat it as generator metadata only.
...
Write .workflow-artifacts/generated/verify-simplified-cli-smoke/lead-plan.md ending with GENERATION_LEAD_PLAN_READY.`,
      verification: { type: 'file_exists', value: ".workflow-artifacts/generated/verify-simplified-cli-smoke/lead-plan.md" },
    })
...
- No explicit file targets were supplied. Write all created file paths (one per line) to .workflow-artifacts/generated/verify-simplified-cli-smoke/output-manifest.txt. Keep changes bounded.
...
Before editing, read .workflow-artifacts/generated/verify-simplified-cli-smoke/matched-skills.md when it exists and use it only as generation-time context for this task.
...
Keep execution routing explicit for local, cloud, and MCP callers. Materialize outputs to disk, then stop for deterministic gates.`,
    ...
    .step("post-implementation-file-gate", {
      ...
      command: "test -f '.workflow-artifacts/generated/verify-simplified-cli-smoke/output-manifest.txt' && test -s '.workflow-artifacts/generated/verify-simplified-cli-smoke/output-manifest.txt' && while IFS= read -r f; do test -f \"$f\"; done < '.workflow-artifacts/generated/verify-simplified-cli-smoke/output-manifest.txt'",
      captureOutput: true,
      failOnError: true,
    })
...
Write .workflow-artifacts/generated/verify-simplified-cli-smoke/review-claude.md ending with REVIEW_COMPLETE.`,
      verification: { type: 'file_exists', value: ".workflow-artifacts/generated/verify-simplified-cli-smoke/review-claude.md" },
    })
...
Write .workflow-artifacts/generated/verify-simplified-cli-smoke/review-codex.md ending with REVIEW_COMPLETE.`,
      verification: { type: 'file_exists', value: ".workflow-artifacts/generated/verify-simplified-cli-smoke/review-codex.md" },
    })

    .step("read-review-feedback", {
      type: 'deterministic',
      dependsOn: ["review-claude", "review-codex"],
      command: "test -f '.workflow-artifacts/generated/verify-simplified-cli-smoke/review-claude.md' && test -f '.workflow-artifacts/generated/verify-simplified-cli-smoke/review-codex.md' && cat '.workflow-artifacts/generated/verify-simplified-cli-smoke/review-claude.md' '.workflow-artifacts/generated/verify-simplified-cli-smoke/review-codex.md' > '.workflow-artifacts/generated/verify-simplified-cli-smoke/review-feedback.md'",
      captureOutput: true,
      failOnError: true,
    })
...
Inputs:
- .workflow-artifacts/generated/verify-simplified-cli-smoke/review-feedback.md
...
Write .workflow-artifacts/generated/verify-simplified-cli-smoke/final-review-claude.md ending with FINAL_REVIEW_CLAUDE_PASS.`,
      verification: { type: 'file_exists', value: ".workflow-artifacts/generated/verify-simplified-cli-smoke/final-review-claude.md" },
    })
...
Write .workflow-artifacts/generated/verify-simplified-cli-smoke/final-review-codex.md ending with FINAL_REVIEW_CODEX_PASS.`,
      verification: { type: 'file_exists', value: ".workflow-artifacts/generated/verify-simplified-cli-smoke/final-review-codex.md" },
    })

    .step("final-review-pass-gate", {
      type: 'deterministic',
      dependsOn: ["final-review-claude", "final-review-codex"],
      command: "tail -n 1 '.workflow-artifacts/generated/verify-simplified-cli-smoke/final-review-claude.md' | tr -d '[:space:]*' | grep -Eq '^FINAL_REVIEW_CLAUDE_PASS$' && tail -n 1 '.workflow-artifacts/generated/verify-simplified-cli-smoke/final-review-codex.md' | tr -d '[:space:]*' | grep -Eq '^FINAL_REVIEW_CODEX_PASS$'",
      captureOutput: true,
      failOnError: true,
    })
    ...
    .step("git-diff-gate", {
      ...
      command: "test -s '.workflow-artifacts/generated/verify-simplified-cli-smoke/output-manifest.txt' && : > '.workflow-artifacts/generated/verify-simplified-cli-smoke/git-diff.txt' && while IFS= read -r f; do { git diff --name-only -- \"$f\"; git ls-files --others --exclude-standard -- \"$f\"; } >> '.workflow-artifacts/generated/verify-simplified-cli-smoke/git-diff.txt'; done < '.workflow-artifacts/generated/verify-simplified-cli-smoke/output-manifest.txt' && sort -u '.workflow-artifacts/generated/verify-simplified-cli-smoke/git-diff.txt' -o '.workflow-artifacts/generated/verify-simplified-cli-smoke/git-diff.txt' && test -s '.workflow-artifacts/generated/verify-simplified-cli-smoke/git-diff.txt'",
      captureOutput: true,
      failOnError: true,
    })
    ...
    .step('final-signoff', {
      ...
      task: `Write .workflow-artifacts/generated/verify-simplified-cli-smoke/signoff.md.
...
- review verdicts
- skill application boundary from .workflow-artifacts/generated/verify-simplified-cli-smoke/skill-application-boundary.json
- remaining risks or environmental blockers

Tool selection: runner=@agent-relay/sdk; concurrency=1; rule=project default runner @agent-relay/sdk.

End with GENERATED_WORKFLOW_READY.`,
      verification: { type: 'file_exists', value: ".workflow-artifacts/generated/verify-simplified-cli-smoke/signoff.md" },
    })
