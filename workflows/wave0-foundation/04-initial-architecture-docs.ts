...
Check the original review checklist again and verify any earlier concrete failures were fixed. Write .workflow-artifacts/wave0-foundation/architecture-docs/final-review.md and end with REVIEW_ARCHITECTURE_PASS or REVIEW_ARCHITECTURE_FAIL.`,
    ...
    .step('final-signoff', {
      ...
      task: `Write .workflow-artifacts/wave0-foundation/architecture-docs/signoff.md.

Include files changed, validation commands run, review verdicts, and remaining risks.
End with W0_ARCHITECTURE_DOCS_WORKFLOW_COMPLETE.`,
      verification: { type: 'file_exists', value: '.workflow-artifacts/wave0-foundation/architecture-docs/signoff.md' },
    })
