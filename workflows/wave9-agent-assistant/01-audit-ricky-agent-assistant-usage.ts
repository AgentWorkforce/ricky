  ...
  const result = await workflow('ricky-wave9-audit-agent-assistant-usage')
    ...
    .step('prepare-context', {
      ...
      command: [
        ...
        'sed -n "1,260p" src/surfaces/cli/commands/cli-main.ts > .workflow-artifacts/wave9-agent-assistant/audit-ricky-agent-assistant-usage/cli-main.before.txt',
        'sed -n "1,260p" src/surfaces/cli/entrypoint/interactive-cli.ts > .workflow-artifacts/wave9-agent-assistant/audit-ricky-agent-assistant-usage/interactive-cli.before.txt',
        'sed -n "1,320p" src/local/entrypoint.ts > .workflow-artifacts/wave9-agent-assistant/audit-ricky-agent-assistant-usage/local-entrypoint.before.txt',
        'sed -n "1,240p" src/product/generation/skill-loader.ts > .workflow-artifacts/wave9-agent-assistant/audit-ricky-agent-assistant-usage/skill-loader.before.txt',
